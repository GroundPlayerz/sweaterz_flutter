...
class QuestionFeedPostDetailScreen extends StatefulWidget {
  ...
  _QuestionFeedPostDetailScreenState createState() =>
      _QuestionFeedPostDetailScreenState();
}

class _QuestionFeedPostDetailScreenState
    extends State<QuestionFeedPostDetailScreen> {
  @override
  void initState() {
